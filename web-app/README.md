...
- Uses ng-boilerplate, an opinionated kickstarter for [AngularJS](http://angularjs.org) projects.
...
```sh
$ git clone git://github.com/elec-otago/WoW
$ cd backend/node/ng/
...
Finally, open `ng/build/index.html` in your browser.
